...
import CustomerName from '@salesforce/retail-react-app/app/components/customer-name'
const MyHeader = ({name}) => {
    console.log('**************** This is a custom header component ****************')
    return (
        <Box>
            <h1>Hello, {name}!</h1>
            <Alert padding="10" status="success">
                <AlertIcon />
                Your sneakers may take longer than usual to deliver!
            </Alert>
        </Box>
    )
}

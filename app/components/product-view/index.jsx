...
const ProductView = forwardRef(
    (
        ...
        const [activePromotionId, setActivePromotionId] = useState(undefined) 
// this is the hovered over promotion, set onOpen, removed onClose
const {productPromotions} = product || {} 
// this destructures productPromotions from the product API call, used in the iterator loop to show promo calloutMsg
...
//this takes the response from the hook above, and sets it in "promos" - this is what we'll use to build the tooltip.
            ...
            <Flex direction={'column'} data-testid="product-view" ref={ref}>
                ...
                <Flex direction={['column', 'column', 'column', 'row']}>
                    ...
                    <VStack align="stretch" spacing={8} flex={1}>
                        ...
                        {/* productPromotions is destructured from product.productPromotions. That loop will build each line.  We will then call the setActivePromotionId method, which will prompt a re-render of the React SDK usePromotions, which will return a "promotions" object that is set to "Promos".
                        Because we are fetching ONLY a single promotion, we can reference the "details" attribute of the first element returned.
                                     */}
                        <Box>
